...
if($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $sql = "SELECT user_id FROM library_user WHERE user_id = '$user_id' and password = '$password'";
      ...
      <div style = "width:300px; border: solid 1px #333333; " align = "left">
         ...
         <div style = "margin:30px">
            ...
            <form action = "" method = "post">
               <label>User Id  :</label><br><br><input type = "text" name = "username" class = "box"/><br /><br />
